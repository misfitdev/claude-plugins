...
2.  **Select Code Style Guides:**
    -   **Locate Plugin Templates:** Before listing guides, resolve the plugin's template directory. Run the following to find the conductor plugin installation path:
        ```bash
