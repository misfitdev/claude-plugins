...
name: conductor
description: >
  Context-driven spec-driven development workflow manager. Organizes work into tracks with
  specs, plans, and changelogs. Provides file resolution, track state management, and
  workflow enforcement. Invoke with /conductor:setup, /conductor:new-track,
  /conductor:implement, /conductor:status, /conductor:review, or /conductor:revert.
---
